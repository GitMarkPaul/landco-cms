...
<!-- .text-block -->
<section class="room-type-section pt-115 pb-115" style="background-image: url('{{ asset("assets/img/bg/01.jpg") }}');">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                ...
                <ul class="room-filter nav nav-pills justify-content-center wow fadeInUp" id="tabs_projects"
                    ...
                    <li class="nav-item"><a class="nav-link active" id="tab_3" data-toggle="pill" href="#peaks">Peaks</a></li>
                    <li class="nav-item"><a class="nav-link" id="tab_4" data-toggle="pill" href="#shores">Shores</a></li>
        ...
        <div class="tab-content mt-65" id="tab_content_projects">
            ...
            <!-- Peaks -->
            <div class="tab-pane fade show active" id="peaks" role="tabpanel">
                <div class="room-items">
                    <div class="row">
            ...
            <!-- Peaks -->
            <div class="tab-pane fade" id="shores" role="tabpanel">
                <div class="room-items">
                    <div class="row">
                        <div class="col-md-4 wow fadeInUp">
                            <div class="room-box">
