...
<section class="breadcrumb-area" style="background-image: url('{{ asset("assets/img/banners/banner-vision.jpg") }}');">
    <div class="container">
        <div class="breadcrumb-text">
            <h2 class="page-title wow fadeInLeft" data-wow-delay="0.2s">Hacienda Escudero</h2>

            <!-- .breadcrumb-nav -->
            <ul class="breadcrumb-nav wow fadeInRight">
                <li><a href="{{ route('index') }}">Home</a></li>
                <li><a href="{{ route('projects') }}">Projects</a></li>
                <li class="active">Hacienda Escudero</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="offer-boxes-loop">
            <div class="offer-box">
                <div class="thumb wow fadeInUp">
                    <img src="{{ asset('assets/img/projects/hacienda-escudero/main-img.jpg') }}" alt="images">
                </div>
                <div class="offer-desc">
                    <div class="title-wrap pb-0">
                        <div class="title col-lg-8 wow fadeInLeft">
                            <h2>Own your own Hacienda!</h2>
                        </div>
                        <div class="price col-lg-4 wow fadeInRight" data-wow-delay=".2s">                                
                            <img src="{{ asset('assets/img/projects/hacienda-escudero/logo.png') }}" alt="images">
                        </div>
                    </div>
                    <div class="row justify-content-between wow fadeInUp">
                        <div class="col-lg-6">
                            <div class="offer-text">
                                <p>Set on the Escudero ancestral lands, this sprawling 180-hectare property is known for its rich cultural heritage and breathtaking natural beauty. It offers its homeowners the exclusive inclusion into one of the most prestigious, storied residential communities in Tiaong, Quezon.</p>
                                <p>Delight in the picturesque charm of Hacienda Escudero and be inspired by its legendary Filipino architecture and hospitality. With its close proximity to the famed resort-plantation Villa Escudero, you can experience nature at a moment’s notice with kayak rides, fishing, nature walks and sumptuous garden-fresh feasts for you to enjoy.</p>
                                <p>Hacienda Escudero is graced by the panoramic views of Mt. Banahaw, Mt. Cristobal and Mt. Makiling. It offers nature lovers the vibrancy of rivers Bulakin and Labasin.</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="offer-feature">
                                <blockquote class="quote-card">
                                    <p>Hacienda Escudero takes homeowners back to a simpler and more meaningful way of life. It integrates Filipino culture into every aspect of living while providing all the modern amenities and facilities needed to ensure a relaxed and laidback lifestyle.</p>
                                </blockquote>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6 col-md-10 order-1 order-lg-2 wow fadeInRight" data-wow-delay=".3s">
                 <img src="{{ asset('assets/img/projects/hacienda-escudero/amenities-img.jpg') }}" alt="images">
            </div>
        </div>
    </div>
        ...
        <div class="cta-inner">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-9 col-10 order-2 order-lg-1 wow fadeInLeft">
                    <img src="{{ asset('assets/img/projects/hacienda-escudero/quick-fact-img.jpg') }}" alt="images">
                </div>
                    ...
                    <div class="cta-features">							
                        ...
                        <div class="single-feature mb-0 wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="cta-desc">
                                ...
                                <p>Brgy. Bulakin, Tiaong, Quezon</p>
                            </div>
                        </div>
                        ...
                        <div class="single-feature mb-0 wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="cta-desc">
                                ...
                                <p><strong>PHP 2,600,000 – 9,000,000</strong><br />(average lot size is 260 to 980 square meters)</p>
                            </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center no-gutters">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".2s">
                <img src="{{ asset('assets/img/projects/hacienda-escudero/construction-img.jpg') }}" alt="images">
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay=".3s">
                <div class="block-text">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>Electrical</td>
                            <td>Phase 1<br />Phase 2A</td>
                            <td>30% Completed<br />10% Completed</td>
                        </tr>
                        <tr>
    ...
    <div class="container-fluid p-0">
        <div class="instagram-slider">
            <div class="image wow fadeInUp">
                <a href="{{ asset('assets/img/projects/hacienda-escudero/gallery/1.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/hacienda-escudero/gallery/1.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".2s">
                <a href="{{ asset('assets/img/projects/hacienda-escudero/gallery/2.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/hacienda-escudero/gallery/2.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".3s">
                <a href="{{ asset('assets/img/projects/hacienda-escudero/gallery/3.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/hacienda-escudero/gallery/3.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".4s">
                <a href="{{ asset('assets/img/projects/hacienda-escudero/gallery/4.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/hacienda-escudero/gallery/4.jpg') }}" alt="instagram-feed">
                </a>
            </div>                
        </div>
    </div>
