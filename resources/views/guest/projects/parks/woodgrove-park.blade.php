...
<section class="breadcrumb-area" style="background-image: url('{{ asset("assets/img/banners/banner-vision.jpg") }}');">
    <div class="container">
        <div class="breadcrumb-text">
            <h2 class="page-title wow fadeInLeft" data-wow-delay="0.2s">Woodgrove Park </h2>

            <!-- .breadcrumb-nav -->
            <ul class="breadcrumb-nav wow fadeInRight">
                <li><a href="{{ route('index') }}">Home</a></li>
                <li><a href="{{ route('projects') }}">Projects</a></li>
                <li class="active">Woodgrove Park </li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="offer-boxes-loop">
            <div class="offer-box">
                <div class="thumb wow fadeInUp">
                    <img src="{{ asset('assets/img/projects/woodgrove-park/main-img.jpg') }}" alt="images">
                </div>
                <div class="offer-desc">
                    <div class="title-wrap pb-0">
                        <div class="title col-lg-8 wow fadeInLeft">
                            <h2>Enjoy the best of San Fernando</h2>
                        </div>
                        <div class="price col-lg-4 wow fadeInRight" data-wow-delay=".2s">                                
                            <img src="{{ asset('assets/img/projects/woodgrove-park/logo.png') }}" alt="images">
                        </div>
                    </div>
                    <div class="row justify-content-between wow fadeInUp">
                        <div class="col-lg-12">
                            <div class="offer-text">
                                <p>Situated in San Fernando, Pampanga, Woodgrove Park is Pampanga’s newest oasis. This exclusive enclave projects residential luxury in a hundred different ways.</p>
                                <p>Designed to reflect the timeless elegance and architectural glory of the American South, Woodgrove Park’s elegantly crafted homes exude a distinct Southern American charm. Adorned by porches and wood panels, Woodgrove Park features wide tree-lined streets and expansive gardens.</p>									
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center justify-content-center wow fadeInLeft" data-wow-delay=".3s">
            <div class="col-lg-7">
                <div class="text-img text-center text-lg-left mb-small">
                   <img src="{{ asset('assets/img/projects/woodgrove-park/amenities-img.jpg') }}" alt="images">
                </div>
            </div>
            <div class="col-lg-5 col-md-8 col-sm-10 wow fadeInRight" data-wow-delay=".5s">
                <div class="block-text">
                    <p>A variety of amenities that matches a cozy and tranquil Southern life are savored at WoodGrove Park.</p>
                    <p>To cozy and tranquil vibe of Woodgrove Park are complemented by amenities that allow the community to enjoy what the property has to offer, like the vast expanse of space of the development through its well-manicured gardens and connecting jogging trails.</p>
                    <p>Take a dip into the cool waters of Woodgrove’s free-form adult and kiddie pool and savor the laughs and fun times at Woodgrove’s Clubhouse.</p>
                    <p>Woodgrove Park’s proximity to North Luzon Expressway (NLEX) and the city’s main thoroughfare, the Olongapo-Gapan Road makes it highly-accessible to the conveniences and attractions San Fernando has to offer.</p>
                    <p>Enjoy the best of San Fernando. Live in Woodgrove Park.</p>						
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 wow fadeInLeft">
                <div class="block-text">
                    ...
                    <ul class="list-icon">
                        <li>2.5-hectare amenity block</li>
                        <li>Grand ballroom</li>
                        <li>Central park</li>
                        <li>Free-form adult pool and kiddie pool</li>
        ...
        <div class="cta-inner">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-9 col-10 order-2 order-lg-1 wow fadeInLeft">
                    <img src="{{ asset('assets/img/projects/woodgrove-park/quick-fact-img.jpg') }}" alt="images">
                </div>
                    ...
                    <div class="cta-features">							
                        ...
                        <div class="single-feature mb-0 wow fadeInUp">
                            ...
                            <div class="cta-desc">
                                ...
                                <p>Brgy. Del Carmen, San Fernando City, Pampanga</p>
                            </div>
                        </div>
                        ...
                        <div class="single-feature mb-0 wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="cta-desc">
                                ...
                                <p><strong>HP 4,400,000 – 6,000,000</strong><br />(average lot size is 265 to 370 square meters)</p>
                            </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center no-gutters">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".2s">
                 <img src="{{ asset('assets/img/projects/woodgrove-park/construction-img.jpg') }}" alt="images">
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay=".3s">
                <div class="block-text">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>Electrical</td>
                            <td>Cluster 1, 2B, 3A-B<br />Cluster 2A</td>
                            <td>100% Completed<br />65% Completed</td>
                        </tr>
                    </table>
                </div>
            </div>
