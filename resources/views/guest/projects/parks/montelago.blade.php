...
<section class="breadcrumb-area" style="background-image: url('{{ asset("assets/img/banners/banner-vision.jpg") }}');">
    <div class="container">
        <div class="breadcrumb-text">
            <h2 class="page-title wow fadeInLeft" data-wow-delay="0.2s">MonteLago Nature Estates</h2>

            <!-- .breadcrumb-nav -->
            <ul class="breadcrumb-nav wow fadeInRight">
                <li><a href="{{ route('index') }}">Home</a></li>
                <li><a href="{{ route('projects') }}">Projects</a></li>
                <li class="active">MonteLago Nature Estates</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="offer-boxes-loop">
            <div class="offer-box">
                <div class="thumb wow fadeInUp">
                    <img src="{{ asset('assets/img/projects/montelago/main-img.jpg') }}" alt="images">
                </div>
                <div class="offer-desc">
                    <div class="title-wrap pb-0">
                        <div class="title col-lg-8 wow fadeInLeft">
                            <h2>Southern Laguna’s Most Exclusive Community</h2>
                        </div>
                        <div class="price col-lg-4 wow fadeInRight" data-wow-delay=".2s">                                
                            <img src="{{ asset('assets/img/projects/montelago/logo.png') }}" alt="images">
                        </div>
                    </div>
                    <div class="row justify-content-between wow fadeInUp">
                        <div class="col-lg-12">
                            <div class="offer-text">
                                <p>Located on a sprawling 35-hectare development, MonteLago Nature Estates is one of the crown jewels of the Escudero legacy. It introduces a new lifestyle designed to elevate community living in Southern Laguna.</p>
                                <p>Masterfully planned and skillfully executed, MonteLago Nature Estates offers a refreshing and relaxed feel, making it a quiet haven for you to come home to everyday.</p>									
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center justify-content-center wow fadeInLeft" data-wow-delay=".3s">
            <div class="col-lg-7">
                <div class="text-img text-center text-lg-left mb-small">
                   <img src="{{ asset('assets/img/projects/montelago/amenities-img.jpg') }}" alt="images">
                </div>
            </div>
            <div class="col-lg-5 col-md-8 col-sm-10 wow fadeInRight" data-wow-delay=".5s">
                <div class="block-text">
                    <p>Its peaceful and nurturing family environment offers a variety of bonding opportunities with family and friends. A wide variety of amenities includes a clubhouse, adult and children’s swimming pools with sunken deck and kiddie play area.</p>
                    <p>With the majestic Mount Cristobal, Mount Makiling and Mount Banahaw in the background, Montelago Nature Estates offers the tradition, prestige, culture and true leisure living that Landco and the Escudero estate have been known for over the years.</p>	
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 wow fadeInLeft">
                <div class="block-text">
                    ...
                    <ul class="list-icon">
                        <li>Southern Californian architecture</li>
                        <li>Wide landscaped roads</li>
                        <li>Two entrance gates</li>
                        <li>Uniquely designed park: Plaza Sacramento</li>
                        <li>Clubhouse</li>
        ...
        <div class="cta-inner">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-9 col-10 order-2 order-lg-1 wow fadeInLeft">
                    <img src="{{ asset('assets/img/projects/montelago/quick-fact-img.jpg') }}" alt="images">
                </div>
                    ...
                    <div class="cta-features">							
                        ...
                        <div class="single-feature mb-0 wow fadeInUp">
                            ...
                            <div class="cta-desc">
                                ...
                                <p>Barangay Sta. Elena, San Pablo, City</p>
                            </div>
                        </div>
                        ...
                        <div class="single-feature mb-0 wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="cta-desc">
                                ...
                                <p><strong>PHP 1,250,000 – 2,500,000</strong><br />(average lot size is 180 to 330 square meters)</p>
                            </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center no-gutters">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".2s">
                 <img src="{{ asset('assets/img/projects/montelago/construction-img.jpg') }}" alt="images">
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay=".3s">
                <div class="block-text">
                    ...
                    <table class="table">
                        <tr>
                            <td>Roadworks</td>
                            <td>Phase 1A<br />Phase 1C<br />Phase 1D</td>
                            <td>100% Completed<br />80% Completed<br />51% Completed</td>
                        </tr>
                        <tr>
                            <td>Waterline</td>
                            <td>Phase 1A<br />Phase 1C<br />Phase 1D</td>
                        ...
                        <tr>
                            <td>Electrical</td>
                            <td>Phase 1A<br />Phase 1D</td>
                            <td>52% Completed<br />13% Completed</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="container-fluid p-0">
        <div class="instagram-slider">
            <div class="image wow fadeInUp">
                <a href="{{ asset('assets/img/projects/montelago/gallery/1.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/montelago/gallery/1.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".2s">
                <a href="{{ asset('assets/img/projects/montelago/gallery/2.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/montelago/gallery/2.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".3s">
                <a href="{{ asset('assets/img/projects/montelago/gallery/3.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/montelago/gallery/3.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".4s">
                <a href="{{ asset('assets/img/projects/montelago/gallery/4.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/montelago/gallery/4.jpg') }}" alt="instagram-feed">
                </a>
            </div>                
        </div>
    </div>
