...
<section class="breadcrumb-area" style="background-image: url('{{ asset("assets/img/banners/banner-vision.jpg") }});">
    <div class="container">
        <div class="breadcrumb-text">
            <h2 class="page-title wow fadeInLeft" data-wow-delay="0.2s">Leisure Farms</h2>

            <!-- .breadcrumb-nav -->
            <ul class="breadcrumb-nav wow fadeInRight">
                <li><a href="{{ route('index') }}">Home</a></li>
                <li><a href="{{ route('projects') }}">Projects</a></li>
                <li class="active">Leisure Farms</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="offer-boxes-loop">
            <div class="offer-box">
                <div class="thumb wow fadeInUp">
                    <img src="{{ asset('assets/img/projects/leisure-farms/main-img.jpg') }}" alt="images">
                </div>
                <div class="offer-desc">
                    <div class="title-wrap pb-0">
                        ...
                        <div class="price col-lg-4 wow fadeInRight" data-wow-delay=".2s">                                
                            <img src="{{ asset('assets/img/projects/leisure-farms/logo.png') }}" alt="images">
                        </div>
                    </div>
                    <div class="row justify-content-between wow fadeInUp">
                        <div class="col-lg-6">
                            <div class="offer-text">
                                <p>Enjoy a quick getaway and experience a laidback life at the countryside in Leisure Farms. The first hobby-farming community in the Philippines, making it the ultimate residence for the Filipino hobby farmer!</p>
                                <p>Located on 116 hectares of rich farmland in Lemery, Batangas, Leisure Farms integrates residential resort features with high-value modern farming. It offers homeowners a safe and delightful place for hobby farmers and their families to spend productive weekdays and blissful weekends.</p>
                                <p>Engage in fun-filled and productive activities! Whether you’re planting seeds, watering the soil or harvesting the fruits of your labor, Leisure Farms offers you a relaxing place to take in the beauty of the surroundings and the freshness of farm life.</p>	
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="offer-feature">
                                <h4>Creature Comforts on Fertile Farmland</h4>									
                                <blockquote class="quote-card">
                                    <p>Leisure Farms is where you go back to basics, commune with nature and harvest the fullness of life. It is not just a farmland; it offers real, complete and self-sustaining agricultural amenities.</p>
                                </blockquote>
                                <p>Aside from modern amenities, perimeter fencing, 24-hour security and farm management services, Leisure Farms provides plenty of opportunities for that good old country fun such as nature trails and fish ponds, as well as a clubhouse, swimming pool and sports area.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6 col-md-10 order-1 order-lg-2 wow fadeInRight" data-wow-delay=".3s">
                 <img src="{{ asset('assets/img/projects/leisure-farms/amenities-img.jpg') }}" alt="images">
            </div>
        </div>
    </div>
        ...
        <div class="cta-inner">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-9 col-10 order-2 order-lg-1 wow fadeInLeft">
                    <img src="{{ asset('assets/img/projects/leisure-farms/quick-fact-img.jpg') }}" alt="images">
                </div>
                    ...
                    <div class="cta-features">							
                        ...
                        <div class="single-feature mb-0 wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="cta-desc">
                                ...
                                <p><strong>PHP 6,105,000 – 16,700,000</strong><br />(average lot size is 1000 to 2700 square meters)</p>
                            </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center no-gutters">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".2s">
                 <img src="{{ asset('assets/img/projects/leisure-farms/construction-img.jpg') }}" alt="images">
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay=".3s">
                <div class="block-text">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>Electrical</td>
                            <td>Ph1 and 2<br />Phase 3</td>
                            <td>100% Completed<br />92% Completed</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="container-fluid p-0">
        <div class="instagram-slider">
            <div class="image wow fadeInUp">
                <a href="{{ asset('assets/img/projects/leisure-farms/gallery/1.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/leisure-farms/gallery/1.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".2s">
                <a href="{{ asset('assets/img/projects/leisure-farms/gallery/2.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/leisure-farms/gallery/2.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".3s">
                <a href="{{ asset('assets/img/projects/leisure-farms/gallery/3.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/leisure-farms/gallery/3.jpg') }}" alt="instagram-feed">
                </a>
            </div>
            <div class="image wow fadeInUp" data-wow-delay=".4s">
                <a href="{{ asset('assets/img/projects/leisure-farms/gallery/4.jpg') }}" class="insta-popup">
                    <img src="{{ asset('assets/img/projects/leisure-farms/gallery/4.jpg') }}" alt="instagram-feed">
                </a>
            </div>                
        </div>
    </div>
