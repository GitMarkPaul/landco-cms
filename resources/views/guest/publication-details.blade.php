...
<section class="breadcrumb-area" style="background-image: url('{{ asset("assets/img/banners/banner-about.jpg") }}');">
    <div class="container">
        <div class="breadcrumb-text">
            <span class="wow fadeInLeft">Press Release</span>
            <h2 class="page-title wow fadeInLeft" data-wow-delay="0.2s">{{ $details->title }}</h2>

            <!-- .breadcrumb-nav -->
            <ul class="breadcrumb-nav wow fadeInRight">
                <li><a href="{{ route('index') }}">Home</a></li>
                <li class="active">Raising the Benchmark in Resort Living</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-4 col-md-8 col-sm-10">
                <div class="sidebar">
                    ...
                    <div class="widget about-author-widget mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="widget-title">{{ $details->author }}</h5>
