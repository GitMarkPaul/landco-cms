 ...
 <section class="breadcrumb-area" style="background-image: url('{{ asset("assets/img/banners/banner-about.jpg") }}');">
    <div class="container">
        <div class="breadcrumb-text">
            ...
            <h2 class="page-title wow fadeInLeft" data-wow-delay="0.2s">Magazine</h2>
    ...
    <div class="container" data-js="publications">
        <div class="row">
            <div class="col-md-12 mb-5">
                <h3 class="page-title wow fadeInUp text-center">Magazine about landco</h3>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="grid">
                    @foreach ($publications as $key => $value)
                        @if ($value->category->category_name == 'Landco Magazine')
